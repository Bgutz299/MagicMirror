...
token = spotipy.util.prompt_for_user_token(username = None, scope=scope, client_id=cid, client_secret=secret, redirect_uri='https://Smartmirror.com/auth', cache_path=None)
